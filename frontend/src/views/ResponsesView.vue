  ...
  <div class="page-panel">
    ...
    <div v-else>
      ...
      <div class="charts-2col">
        ...
        <!-- Categorical chart card: donut / bar / table (shared QuestionChartCard) -->
...
// Chart-type (donut / bar / table) per question — shared with DashboardView
// via useChartTypePrefs so both pages render and remember it the same way.
